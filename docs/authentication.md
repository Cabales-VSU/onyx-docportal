...
---
## [Project Homepage](project-homepage.md) > **Authentication**
...
| :---: | :--- | :--- |
| **1** | User enters email and password. | System validates credentials against **Supabase**. |
| **2** | User clicks "Login". | System redirects to the specific user dashboard. |
